...
class View extends \yii\base\View
{
    ...
    /**
     * @var \yii\web\AssetBundle[] list of the registered asset bundles. The keys are the bundle names, and the values
    ...
    public function registerCssFile($url, $options = [], $key = null)
    {
        ...
        if (empty($depends)) {
            ...
            $this->getAssetManager()->bundles[$key] = new \yii\web\AssetBundle([
                'baseUrl' => '',
