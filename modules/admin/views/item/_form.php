...
'condition'=>['type'=> TabularForm::INPUT_TEXT, 'options'=>['placeholder'=>'Enter Condition...']], 
...
'min_renting_days'=>['type'=> Form::INPUT_TEXT, 'options'=>['placeholder'=>'Enter Min Renting Days...']], 
...
'name'=>['type'=> Form::INPUT_TEXT, 'options'=>['placeholder'=>'Enter Name...', 'maxlength'=>140]], 
    ...
    echo Html::submitButton($model->isNewRecord ? 'Create', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']);
    ActiveForm::end(); ?>
