...
<div class="col-md-3 card" id="booking-widget">
    ...
    <div class="row">
        <div class="shortTermPrice">
            <div class="col-md-4 ">
                <h4>
                    <?= round($model->item->getDailyPrice()) . ",-" ?>
                </h4>
            ...
            <div class="col-md-4">
                <h4>
                    <?= round($model->item->getWeeklyPrice()) . ",-" ?>
                </h4>
            ...
            <div class="col-md-4"
                 id="viewLongTerm" <?= \app\components\web\ViewHelper::trackClick("item.click_long_bookwidget",
                $model->item->id) ?>>
                <h4>
        ...
        <div class="longTermPrice" style="display: none;">
            <div class="col-md-4 "
                 id="viewShortTerm" <?= \app\components\web\ViewHelper::trackClick("item.click_short_bookwidget",
                $model->item->id) ?>>
                <h4>
            ...
            <div class="col-md-4">
                <h4>
                    <?= round($model->item->getMonthlyPrice()) . ",-" ?>
                </h4>
            ...
            <div class="col-md-4">
                <h4>
                    <?= round($model->item->getYearlyPrice()) . ",-" ?>
                </h4>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            ->label(false)
            ->widget(DatePicker::className(), [// these functions are defined in ./assets/booking_widget.js
            'clientOptions' => ['beforeShowDay' => new JsExpression('widget.dateFrom.beforeShowDay'),
        ...
        <div class="col-sm-6">
            ...
            ['options' => ['class' => 'drp-container form-group'],])->label(false)->widget(DatePicker::className(),
            ['clientOptions' => ['beforeShowDay' => new JsExpression('widget.dateTo.beforeShowDay'),
    ...
    <div class="row">
        <div class="col-md-12">
            <div>
                ...
                'onclick' => \app\components\web\ViewHelper::trackClick("item.click_book_now", $model->item->id, false)]); ?>
                <div class="overlay">
                    <img alt=""
