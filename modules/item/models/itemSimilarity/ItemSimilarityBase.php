...
namespace item\models\itemSimilarity;
...
class ItemSimilarityBase extends \app\components\models\BaseActiveRecord
{
    ...
    {
        return $this->hasOne(\item\models\item\Item::className(), ['id' => 'item_id_2']);
    }
    ...
    {
        return $this->hasOne(\item\models\item\Item::className(), ['id' => 'item_id_1']);
    }
