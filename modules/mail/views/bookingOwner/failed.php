                                ...
                                <td>
                                    <table width="520" cellpadding="0" cellspacing="0" border="0" align="center"
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #000000; text-align:left; line-height: 24px; ">
                                                <p class="BrdtekstA" style="text-align: left;">
                                                    Betaling for leje af <?= $itemName ?> i perioden <?= $startDate ?> - <?= $endDate ?> til <?= $renterName ?> mislykkedes og bookingen er derfor blevet annulleret. Vi har informeret <?= $renterName ?> om denne mislykket betaling da dette kan være en teknisk fejl, kan <?= $renterName ?> stadig være interesseret i at leje <?= $itemName ?>. Såfremt <?= $renterName ?> stadig er interesseret i at leje <?= $itemName ?> vil du modtage en ny booking anmodning.
                                                </p>
                                            </td>
                                        </tr>
                                        <!-- Spacing -->
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #000000; text-align:left; line-height: 24px; ">
                                                <p class="BrdtekstA" style="text-align: left;">
                                                    Har du spørgsmål angående betaling kan du læse mere <a href="<?= $urls['help'] ?>">her</a>
