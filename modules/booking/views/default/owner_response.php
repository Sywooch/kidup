                ...
                <div class="col-sm-12 col-md-10 col-md-offset-1 text-center ">
                    <div class="checkout-header">
                        <h2>
                            ...
                            <small><?= Yii::t("booking", "Respond to {0}'s booking request", [$profile->first_name]) ?></small>
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-md-offset-3 card">
                <h4>
                    <?= \Yii::t('booking', 'User {0} would like to rent your item {1}', [
                        Html::a($profile->first_name, '@web/user/'.$profile->user_id),
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?= Yii::t("booking", "Please be aware that the booking lapses if you have not responded within this timeperiod.") ?>
                        <br/><br/>
                        <b>
